    ...
    return (
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
                <iconify-icon icon={icon} className="text-orange-500 text-lg sm:text-2xl w-5 sm:w-6 text-center flex-shrink-0"></iconify-icon>
...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ isHighContrast, setHighContrast }) => {
    ...
    return (
        <div className="space-y-3 sm:space-y-4">
            <h2 className="text-lg sm:text-xl font-bold text-gray-700">Accessibility & Support</h2>
            
            <Card>
                <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-200 rounded-full flex items-center justify-center flex-shrink-0">
                        <iconify-icon icon="mdi:account-circle-outline" className="text-2xl sm:text-4xl text-gray-500"></iconify-icon>
                    </div>
                    <div className="min-w-0 flex-1">
