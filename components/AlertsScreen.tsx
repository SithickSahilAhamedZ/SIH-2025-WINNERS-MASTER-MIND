    ...
    return (
        <div className="space-y-6 pb-4">
            ...
            <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
                <iconify-icon icon="solar:bell-bing-bold-duotone" className="text-red-500"></iconify-icon>
                Emergency Services
            </h1>
            ...
            <div className="flex flex-col items-center justify-center text-center space-y-3 py-4">
                ...
                >
                    <iconify-icon icon={sosActivated ? "solar:check-circle-bold" : "solar:siren-rounded-bold"} className="text-6xl"></iconify-icon>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
                                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${contact.colors}`}>
                                        <iconify-icon icon={contact.icon} className="text-2xl"></iconify-icon>
                                    </div>
                                    <div>
                    ...
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center space-x-4">
                            <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-orange-100 text-orange-600">
                                <iconify-icon icon="solar:car-crash-bold-duotone" className="text-3xl"></iconify-icon>
                            </div>
                             <div>
                        ...
                        <button className="bg-orange-500 text-white w-12 h-12 rounded-lg shadow-sm hover:bg-orange-600 transition-transform active:scale-95 flex items-center justify-center">
                            <iconify-icon icon="solar:notebook-bold-duotone" className="text-3xl"></iconify-icon>
                        </button>
                    </div>
                </Card>
            </div>
