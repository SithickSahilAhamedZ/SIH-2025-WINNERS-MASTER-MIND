                ...
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <iconify-icon icon="solar:temple-hindu-bold" className="text-3xl"></iconify-icon>
                            <div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            >
                                <iconify-icon icon="solar:calendar-bold" className="text-xl"></iconify-icon>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto p-6 space-y-6">
                ...
                <Card className="transition-all duration-300 shadow-sm p-4 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-2">
                            <iconify-icon icon="solar:chart-square-bold" className="text-blue-600 text-xl"></iconify-icon>
                    ...
                    <div className="mt-3 p-2 bg-blue-100 rounded-lg">
                        <div className="flex items-center justify-center space-x-2">
                            <iconify-icon icon="solar:warning-triangle-bold" className="text-blue-600 text-sm"></iconify-icon>
                    ...
                    <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center space-x-1">
                            ...
                            <div className={`flex items-center space-x-1 text-xs px-1.5 py-0.5 rounded-full transition-all duration-300 ${
                                ...
                                <iconify-icon
                                    icon={isUpdating ? "solar:refresh-bold" : "solar:check-circle-bold"}
                    ...
                    <div className="space-y-2">
                            ...
                            <div className="space-y-1">
                                {alternativeRoutes.slice(0, 2).map((route, index) => (
                                    <div key={index} className="flex items-center justify-between">
                                        <div className="flex items-center space-x-1">
                                            <iconify-icon icon="solar:arrow-right-linear" className="text-gray-400 text-xs"></iconify-icon>
                        ...
                        <div className="p-1.5 bg-blue-50 rounded-md">
                            <div className="flex items-center space-x-1 mb-1">
                                <iconify-icon icon="solar:lightbulb-bold" className="text-blue-600 text-xs"></iconify-icon>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                    ...
                    <Card className="transition-all duration-300 shadow-sm p-3 bg-gradient-to-br from-green-50 to-emerald-50">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center space-x-1">
                                <iconify-icon icon="solar:exit-bold" className="text-green-600 text-lg"></iconify-icon>
                    ...
                    <Card className="transition-all duration-300 shadow-sm p-3 bg-gradient-to-br from-blue-50 to-indigo-50">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center space-x-1">
                                <iconify-icon icon="solar:closet-bold" className="text-blue-600 text-lg"></iconify-icon>
                    ...
                    <Card className="transition-all duration-300 shadow-sm p-3 bg-gradient-to-br from-purple-50 to-violet-50">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center space-x-1">
                                <iconify-icon icon="solar:entrance-bold" className="text-purple-600 text-lg"></iconify-icon>
                    ...
                    <Card className="transition-all duration-300 shadow-sm p-3 bg-gradient-to-br from-orange-50 to-amber-50">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center space-x-1">
                                <iconify-icon icon="solar:plate-bold" className="text-orange-600 text-lg"></iconify-icon>
                    ...
                    <Card className="transition-all duration-300 shadow-sm p-3 bg-gradient-to-br from-red-50 to-rose-50">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center space-x-1">
                                <iconify-icon icon="solar:smartphone-bold" className="text-red-600 text-lg"></iconify-icon>
                    ...
                    <Card className="transition-all duration-300 shadow-sm p-3 bg-gradient-to-br from-teal-50 to-cyan-50">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center space-x-1">
                                <iconify-icon icon="solar:armchair-bold" className="text-teal-600 text-lg"></iconify-icon>
                    ...
                    <Card className="transition-all duration-300 shadow-sm p-3 bg-gradient-to-br from-yellow-50 to-amber-50 col-span-1 sm:col-span-2 lg:col-span-1">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center space-x-1">
                                <iconify-icon icon="solar:info-circle-bold" className="text-yellow-600 text-lg"></iconify-icon>
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                    <button
                        ...
                        className="bg-gradient-to-r from-red-500 to-pink-500 text-white p-4 rounded-xl font-semibold shadow-lg hover:from-red-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-105 flex flex-col items-center space-y-2"
                    >
                        <iconify-icon icon="solar:shield-bold" className="text-2xl"></iconify-icon>
                        <span className="text-sm font-medium">Emergency</span>
                    </button>
                    <button
                        onClick={() => onNavigate('Calendar')}
                        className="bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 rounded-xl font-semibold shadow-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-300 transform hover:scale-105 flex flex-col items-center space-y-2"
                    >
                        <iconify-icon icon="solar:calendar-bold" className="text-2xl"></iconify-icon>
                        <span className="text-sm font-medium">Calendar</span>
                    </button>
                    <button
                        onClick={() => onNavigate('Yatra')}
                        className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white p-4 rounded-xl font-semibold shadow-lg hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 transform hover:scale-105 flex flex-col items-center space-y-2"
                    >
                        <iconify-icon icon="solar:route-bold" className="text-2xl"></iconify-icon>
                        <span className="text-sm font-medium">My Yatra</span>
                    </button>
                </div>
            </div>
