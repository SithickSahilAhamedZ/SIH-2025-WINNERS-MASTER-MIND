      ...
      <div className="space-y-3 sm:space-y-4">
          ...
          <Card className="bg-green-50 border-l-4 border-green-500 animate-fade-in">
            <div className="flex flex-col items-center space-y-2 sm:space-y-3">
                <div className="flex items-center space-x-2 sm:space-x-3">
                    <iconify-icon icon="mdi:check-circle-outline" className="text-base sm:text-lg"></iconify-icon>
        ...
        {!isOnline && (
          <Card className="bg-blue-50 border-l-4 border-blue-400">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <iconify-icon icon="mdi:cloud-off-outline" className="text-base sm:text-lg"></iconify-icon>
              <div>
        ...
        {offlineBookings.filter(b => b.status === 'pending').length > 0 && (
          <Card className="bg-yellow-50 border-l-4 border-yellow-400">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2 sm:space-x-3">
                <iconify-icon icon="mdi:clock-outline" className="text-base sm:text-lg"></iconify-icon>
                <div>
        ...
        {!isOnline && (
          <Card className="bg-blue-50 border-l-4 border-blue-400">
            <div className="flex items-center space-x-3">
              <iconify-icon icon="mdi:cloud-off-outline" className="text-blue-600 text-lg"></iconify-icon>
              <div>
        ...
        {offlineBookings.filter(b => b.status === 'pending').length > 0 && (
          <Card className="bg-yellow-50 border-l-4 border-yellow-400">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <iconify-icon icon="mdi:clock-outline" className="text-yellow-600 text-lg"></iconify-icon>
                <div>
              ...
              <Card key={slot.id} className={`transition-all duration-300 ${slot.booked && isOnline ? 'border-2 border-green-500 shadow-lg' : ''}`}>
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => handleSelectSlot(slot.id)}
                    disabled={buttonState.disabled}
                    className={`px-4 py-2 rounded-lg text-sm font-bold transition-colors ${buttonState.class}`}
                  >
                    {buttonState.text}
                  </button>
                </div>
                ...
                {!isOnline && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 sm:p-3">
                    <div className="flex items-center space-x-1 sm:space-x-2 text-blue-800">
                      <iconify-icon icon="mdi:information-outline" className="text-sm sm:text-lg"></iconify-icon>
