    ...
    <div className="space-y-4">
      ...
      {cameraError && (
        <Card className="bg-red-50 border-l-4 border-red-400">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <iconify-icon icon="mdi:camera-off-outline" className="text-base sm:text-lg"></iconify-icon>
      ...
      {mapNotification && (
        <Card className={mapNotification.type === 'success' ? 'bg-green-50 border-l-4 border-green-400' : 'bg-red-50 border-l-4 border-red-400'}>
            <div className="flex items-center space-x-2 sm:space-x-3">
              <iconify-icon icon={mapNotification.type === 'success' ? "mdi:check-circle-outline" : "mdi:alert-circle-outline"} className={mapNotification.type === 'success' ? 'text-base sm:text-lg text-green-600' : 'text-base sm:text-lg text-red-600'}></iconify-icon>
        ...
        <div className="relative bg-gray-100 h-64 sm:h-80 md:h-96 w-full rounded-lg overflow-hidden">
          ...
          {isCameraOpen && (
            <div className="absolute inset-0 z-10 bg-black flex flex-col items-center justify-center animate-camera-fade-in">
              ...
              <button 
                  ...
                  aria-label="Close"
                >
                  <iconify-icon icon="mdi:close" className="text-lg sm:text-2xl"></iconify-icon>
              </button>
            </div>
          )}
          ...
          <div className="absolute top-2 sm:top-3 right-2 sm:right-3 z-0 flex flex-col space-y-1 sm:space-y-2">
            {mapTransform.scale > 1 && (
              ...
              >
                <iconify-icon icon="solar:home-bold-duotone" className="text-lg sm:text-2xl"></iconify-icon>
              </button>
            )}
            <button 
            ...
            >
              <iconify-icon icon="solar:camera-bold-duotone" className="text-lg sm:text-2xl"></iconify-icon>
            </button>
            <button 
            ...
            >
               <iconify-icon icon="solar:qr-code-bold-duotone" className="text-lg sm:text-2xl"></iconify-icon>
            </button>
          </div>
        </div>
      </Card>
        ...
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="p-1.5 sm:p-2 bg-orange-100 rounded-full">
              <iconify-icon icon="solar:users-group-rounded-bold-duotone" className="text-orange-600 text-base sm:text-lg"></iconify-icon>
            </div>
            <div>
          ...
          <div className="flex items-center space-x-1 sm:space-x-2 text-xs px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-green-100 text-green-700">
            <iconify-icon icon="solar:check-circle-bold" className="text-xs sm:text-sm"></iconify-icon>
            <span>Live</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-3 sm:p-4 rounded-xl">
            <div className="flex items-center justify-between">
              ...
              <iconify-icon icon="solar:users-group-two-rounded-bold-duotone" className="text-2xl sm:text-3xl text-blue-600"></iconify-icon>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-3 sm:p-4 rounded-xl">
            <div className="flex items-center justify-between">
              ...
              <iconify-icon icon="solar:chart-square-bold-duotone" className="text-2xl sm:text-3xl text-amber-600"></iconify-icon>
            </div>
          </div>
        </div>
        ...
        {selectedPOI && (
          <div className="border-t border-gray-100 pt-3 sm:pt-4">
            <h4 className="text-xs sm:text-sm font-semibold text-gray-700 mb-2 sm:mb-3 flex items-center">
              <iconify-icon icon="solar:map-point-bold-duotone" className="mr-1 sm:mr-2 text-gray-500 text-sm sm:text-base"></iconify-icon>
