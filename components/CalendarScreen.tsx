      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white p-6 shadow-lg">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4">
            <iconify-icon icon="solar:calendar-bold" className="text-3xl"></iconify-icon>
            <div>
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <Card className="bg-white shadow-xl">
          <div className="flex items-center mb-4">
            <iconify-icon icon="solar:clock-circle-bold" className="text-2xl text-orange-600 mr-3"></iconify-icon>
