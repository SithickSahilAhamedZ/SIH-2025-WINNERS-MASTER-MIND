    ...
    return (
        <div className="space-y-4 sm:space-y-6 pb-4">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-gray-800 flex items-center gap-2 sm:gap-3">
                <iconify-icon icon="solar:bell-bing-bold-duotone" className="text-red-500 text-lg sm:text-xl"></iconify-icon>
                Emergency Services
            </h1>
            ...
            <div className="flex flex-col items-center justify-center text-center space-y-2 sm:space-y-3 py-3 sm:py-4">
                ...
                >
                    <iconify-icon icon={sosActivated ? "solar:check-circle-bold" : "solar:siren-rounded-bold"} className="text-4xl sm:text-6xl"></iconify-icon>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3 sm:space-x-4 min-w-0 flex-1">
                                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center flex-shrink-0 ${contact.colors}`}>
                                        <iconify-icon icon={contact.icon} className="text-lg sm:text-2xl"></iconify-icon>
                                    </div>
                                ...
                                >
                                    <iconify-icon icon="solar:phone-bold" className="text-sm sm:text-base"></iconify-icon>
                                    Call
                                </a>
                            </div>
                        </Card>
